...
- 站内定邀候选页 `/targeted-screening`：按 TikTok Shop 定邀口径（1,000–100,000 粉、成交 ≥100 件、平均播放 ≥100）预览粘贴表格，按 TikTok 账号跨项目查重，记录近 30 天邀约、黑名单、内容与受众核验，显示逐人排除或待补证据原因；候选仅在相同的 28 天或 30 天统计周期内相对排序。候选队列支持账号搜索、状态筛选和核验进度概览。录入和核验不会发送邀请；站内发送仍需人工完成。
